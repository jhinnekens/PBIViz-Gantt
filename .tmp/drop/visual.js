var milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG;
/******/ (() => { // webpackBootstrap
...
/* harmony import */ var moment_locale_pt_br__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7971);
...
class Visual {
    constructor(options) {
        ...
        if (document) {
            this.planningStartDate = moment__WEBPACK_IMPORTED_MODULE_0__('2021-12-01', 'YYYY-MM-DD').locale('en');
            this.planningEndDate = moment__WEBPACK_IMPORTED_MODULE_0__('2023-12-01', 'YYYY-MM-DD').locale('en');
            this.dateNow = moment__WEBPACK_IMPORTED_MODULE_0__().locale('en');
            this.cursDate = moment__WEBPACK_IMPORTED_MODULE_0__(this.planningStartDate.locale('en'));
            ...
            let startToCurrentMonthStart = moment__WEBPACK_IMPORTED_MODULE_0__(this.dateNow.year().toString() + '-' + (this.dateNow.month() + 1).toString() + '-01', 'YYYY-MM-DD').diff(this.planningStartDate, 'days');
            ...
            const GanttView = this.GanttViewSlideContainer.appendChild(document.createElement("div"));
            ...
            /*Dates */
            const SlideContainer = GanttView.appendChild(document.createElement("div"));
            SlideContainer.classList.add("ganttview-slide-container");
            SlideContainer.setAttribute("style", "width: 975px;");
            const hzheader = SlideContainer.appendChild(document.createElement("div"));
            hzheader.classList.add("ganttview-hzheader");
            const hzheaderMonths = hzheader.appendChild(document.createElement("div"));
            ...
            const hzheaderweeks = hzheader.appendChild(document.createElement("div"));
            ...
            var firstLoop = true;
            // Contol 
            const GanttControl = GanttDiv.appendChild(document.createElement("div"));
            GanttControl.classList.add("GanttControl");
            const GanttControlInner = GanttControl.appendChild(document.createElement("div"));
            GanttControlInner.classList.add("GanttControl-inner");
            const GanttButtonBack = GanttControlInner.appendChild(document.createElement("div"));
            GanttButtonBack.classList.add("GanttControl-Button");
            GanttButtonBack.appendChild(document.createTextNode("<"));
            const GanttButtonForward = GanttControlInner.appendChild(document.createElement("div"));
            GanttButtonForward.classList.add("GanttControl-Button");
            GanttButtonForward.appendChild(document.createTextNode(">"));
            const GanttButtonHome = GanttControlInner.appendChild(document.createElement("div"));
    ...
    addMilestoneTask(cellheightCount, startDate, endDate, isMilestone, level1, level2, name, status) {
        this.usedAvailability = undefined;
        let dateStartText = startDate.format("DD MMM YYYY");
        let dateEndText = endDate.format("DD MMM YYYY");
        let endDateWithMarge = moment__WEBPACK_IMPORTED_MODULE_0__(endDate);
        ...
        if (this.nextAvailabilities.length > 0) {
            ...
            while (i < this.nextAvailabilities.length && !this.usedAvailability) {
                if (moment__WEBPACK_IMPORTED_MODULE_0__(this.nextAvailabilities[i].availability, 'YYYY-MM-DD').isBefore(startDate)) {
        ...
        const milestoneTask = this.ganttviewGrid.appendChild(document.createElement("div"));
        if (isMilestone) {
            ...
            let duration = moment__WEBPACK_IMPORTED_MODULE_0__(endDate).startOf('d').add(1, 'd').diff(moment__WEBPACK_IMPORTED_MODULE_0__(startDate).startOf('d'), 'd');
    ...
    addLevel1(name) {
        const vtheaderItem = this.vtheader.appendChild(document.createElement("div"));
        vtheaderItem.classList.add("ganttview-vtheader-item");
        this.vtheaderItemMaxHeight = 0;
        const vtheaderItemName = vtheaderItem.appendChild(document.createElement("div"));
        ...
        const vtheaderLastSeries = vtheaderItem.appendChild(document.createElement("div"));
        vtheaderLastSeries.classList.add("ganttview-vtheader-series");
        this.vtheaderLastSeries = vtheaderLastSeries;
    }
    addLevel2(sepOnly, name, nameCat1) {
        if (!sepOnly) {
    ...
    addARow(sep) {
        let cell;
        this.cursDate = moment__WEBPACK_IMPORTED_MODULE_0__(this.planningStartDate.locale('en'));
        var ganttviewGridRow = this.ganttviewGrid.appendChild(document.createElement("div"));
    ...
    addMilestoneTooltip(event, level1, level2, dateStart, dateEnd, Name, isMilestone) {
        ...
        const tooltipTitle = this.tooltip.appendChild(document.createElement("h1"));
        tooltipTitle.appendChild(document.createTextNode(Name));
        const tooltipLine1 = this.tooltip.appendChild(document.createElement("div"));
        const tooltipLine1Header = tooltipLine1.appendChild(document.createElement("span"));
        tooltipLine1Header.appendChild(document.createTextNode("Level1: "));
        const tooltipLine1Body = tooltipLine1.appendChild(document.createElement("span"));
        tooltipLine1Body.appendChild(document.createTextNode(level1));
        const tooltipLine2 = this.tooltip.appendChild(document.createElement("div"));
        const tooltipLine2Header = tooltipLine2.appendChild(document.createElement("span"));
        tooltipLine2Header.appendChild(document.createTextNode("Level2: "));
        const tooltipLine2Body = tooltipLine2.appendChild(document.createElement("span"));
        tooltipLine2Body.appendChild(document.createTextNode(level2));
        const tooltipLine3 = this.tooltip.appendChild(document.createElement("div"));
        const tooltipLine3Header = tooltipLine3.appendChild(document.createElement("span"));
        tooltipLine3Header.appendChild(document.createTextNode("Date start: "));
        const tooltipLine3Body = tooltipLine3.appendChild(document.createElement("span"));
        tooltipLine3Body.appendChild(document.createTextNode(dateStart));
        const tooltipLine4 = this.tooltip.appendChild(document.createElement("div"));
        const tooltipLine4Header = tooltipLine4.appendChild(document.createElement("span"));
        tooltipLine4Header.appendChild(document.createTextNode("Date finish: "));
        const tooltipLine4Body = tooltipLine4.appendChild(document.createElement("span"));
    ...
    createVisualForAsetOfData(data) {
        this.resetVisual();
        ...
        data.forEach((d) => {
            ...
            d.values.forEach((e) => {
                ...
                let sortedTable = e.values.sort((a, b) => d3__WEBPACK_IMPORTED_MODULE_2__/* .ascending */ .j2p(parseInt(moment__WEBPACK_IMPORTED_MODULE_0__(a.MilestoneTaskEndDate, 'YYYY-MM-DDTHH:mm:ss').locale('en').format('YYYYMMDD')), parseInt(moment__WEBPACK_IMPORTED_MODULE_0__(b.MilestoneTaskStartDate, 'YYYY-MM-DDTHH:mm:ss').locale('en').format('YYYYMMDD'))));
                sortedTable.forEach((f) => {
                    let status;
                    if (f.MilestoneStatus == 100)
                        status = "done";
                    else if (moment__WEBPACK_IMPORTED_MODULE_0__(f.MilestoneTaskEndDate, 'YYYY-MM-DDTHH:mm:ss').locale('en').isBefore(this.dateNow))
                        status = "late";
                    else
                        status = "todo";
                    this.addMilestoneTask(cellheightCount, moment__WEBPACK_IMPORTED_MODULE_0__(f.MilestoneTaskStartDate, 'YYYY-MM-DDTHH:mm:ss').locale('en'), moment__WEBPACK_IMPORTED_MODULE_0__(f.MilestoneTaskEndDate, 'YYYY-MM-DDTHH:mm:ss').locale('en'), f.isMilestone, f.category1, f.category2, f.MilestoneTaskName, status);
                });
    ...
    nestData(data) {
        ...
        data = d3__WEBPACK_IMPORTED_MODULE_2__/* .nest */ .b1B()
    ...
    update(options) {
        ...
        TableData = TableData.sort((a, b) => d3__WEBPACK_IMPORTED_MODULE_2__/* .ascending */ .j2p(a.MilestoneOrder, b.MilestoneOrder));
        this.data = TableData;
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "j2": () => (/* reexport safe */ _ascending__WEBPACK_IMPORTED_MODULE_1__.Z)
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "b1": () => (/* reexport safe */ _nest__WEBPACK_IMPORTED_MODULE_0__.Z)
/* harmony export */ });
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  function apply(array, depth, createResult, setResult) {
    ...
    var i = -1,
        ...
        keyValue,
        value,
        valuesByKey = (0,_map__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(),
        values,
        result = createResult();
...
function createMap() {
  return (0,_map__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)();
}
...
/* harmony import */ var _join__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3425);
...
"use strict";
/* harmony import */ var _zoom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5847);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "b1B": () => (/* reexport safe */ d3_collection__WEBPACK_IMPORTED_MODULE_5__.b1),
/* harmony export */   "j2p": () => (/* reexport safe */ d3_array__WEBPACK_IMPORTED_MODULE_1__.j2)
/* harmony export */ });
...
/* harmony import */ var d3_transition__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(2263);
/* harmony import */ var d3_voronoi__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(5117);
/* harmony import */ var d3_zoom__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9750);
...
var milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG = {
    name: 'milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG',
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG"] = milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG);

})();

milestoneViz15E2B7204D5B4D19A54D5217B9F634BF_DEBUG = __webpack_exports__;
/******/ })()
;
